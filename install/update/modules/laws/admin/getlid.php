...
$base_url = NV_BASE_ADMINURL . "index.php?" . NV_LANG_VARIABLE . "=" . NV_LANG_DATA . "&" . NV_NAME_VARIABLE . "=" . $module_name . "&" . NV_OP_VARIABLE . "=" . $op . "&amp;area=" . $area . "&amp;submitsave=1";

if ($nv_Request->isset_request('submitsave', 'get')) {
    $array_user = array();
    $generate_page = "";
    ...
    } elseif ($nv_Request->isset_request('submitsave', 'get')) {
