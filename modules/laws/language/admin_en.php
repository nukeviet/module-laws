...
$lang_module['content_cat'] = 'Category of text';
$lang_module['permissions_admin'] = 'Section Manager';
$lang_module['permissions_add_content'] = 'Create articles';
$lang_module['permissions_edit_content'] = 'Edit articles';
$lang_module['permissions_del_content'] = 'Detele articles';
$lang_module['permissions_pub_error'] = 'Error: You are not allowed to post to the Category: %1$s';
$lang_module['permissions_sendspadmin_error'] = 'Error: You are not allowed to transfer posts to the editor in Category: %1$s';
$lang_module['permissions_pub_show_error'] = 'Error: You are not allowed to display posts in Category: %1$s';
$lang_module['admin_cat'] = 'Section Manager';
$lang_module['admin_module'] = 'Management module';
$lang_module['admin_full_module'] = 'Full module';
