...
$db->query("INSERT INTO " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_cat VALUES
	(1, 0, 'Cong-van', 'Công văn', '', '', 5, 1412265295, 1, '1', '0'),
	(2, 0, 'Thong-tu', 'Thông tư', '', '', 5, 1412265295, 2, '2', '0'),
	(3, 0, 'Quyet-dinh', 'Quyết định', '', '', 5, 1412265295, 3, '3', '0'),
	(4, 0, 'Nghi-dinh', 'Nghị định', '', '', 5, 1412265295, 4, '4', '0'),
	(5, 0, 'Thong-bao', 'Thông báo', '', '', 5, 1412998152, 5, '5', '0'),
	(6, 0, 'Huong-dan', 'Hướng dẫn', '', '', 5, 1412998170, 6, '6', '0'),
	(7, 0, 'Bao-cao', 'Báo cáo', '', '', 5, 1412998182, 7, '7', '0'),
	(8, 0, 'Chi-thi', 'Chỉ thị', '', '', 5, 1412998193, 8, '8', '0'),
	(9, 0, 'Ke-hoach', 'Kế hoạch', '', '', 5, 1412998208, 9, '9', '0')");
