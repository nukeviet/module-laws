...
<div class="form-group">
    <a href="{MODULE_URL}=subject&amp;add" class="btn btn-primary">{LANG.addSubject}</a>
</div>
<div class="myh3">
...
<form>
    ...
    <div class="form-group form-inline">
        ...
        <button type="button" class="btn btn-primary" onclick="nv_subject_action(this.form, '{NV_CHECK_SESSION}', '{LANG.msgnocheck}')">{GLANG.submit}</button>
    </div>
</form>
<script type="text/javascript">
    //<![CDATA[
