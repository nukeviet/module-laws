...
if (! function_exists('nv_laws_array_cat_admin')) {
	/**
	 * nv_laws_array_cat_admin()
	 *
	 * @return
	 */
	function nv_laws_array_cat_admin($module_data)
	{
		global $db_slave;
...
$is_refresh = false;
$array_cat_admin = nv_laws_array_cat_admin($module_data);
